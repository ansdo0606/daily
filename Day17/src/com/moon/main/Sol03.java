 ...
 * ad 제거하기
	...
	1번 인덱스의 문자열인 "notad"는 부분 문자열로 "ad"를 가집니다. 따라서 해당 문자열을 제거하고 
	나머지는 순서를 유지하여 ["and","abcd"]를 return 합니다.
	입출력 예 #2
...
public class Sol03 {
	...
	public static void main(String[] args) {
        ...
        String[] result1 = solution.solution(strArr1);
        System.out.println(java.util.Arrays.toString(result1));

        String[] strArr2 = {"there", "are", "no", "a", "ds"};
        String[] result2 = solution.solution(strArr2);
