 ...
 * 주사위 게임 1
	...
	예제 2번에서 두 주사위 숫자 중 하나만 홀수이므로 2 × (6 + 1) = 2 × 7 = 14점을 얻습니다. 따라서 14를 
	return 합니다.
	입출력 예 #3
...
public class Sol04 {
	 public int solution(int a, int b) {
	    ...
	    public static void main(String[] args) {
	        ...
	        System.out.println(solution.solution(3, 5)); // 34
	        System.out.println(solution.solution(6, 1)); // 14
	        System.out.println(solution.solution(2, 4)); // 2
	    }
}
