 ...
 * 정수 찾기
	문제 설명
	정수 리스트 num_list와 찾으려는 정수 n이 주어질 때, num_list안에 n이 있으면 1을 없으면 
...
public class Sol03 {
    ...
    public static void main(String[] args) {
        ...
        int n1 = 3;
        System.out.println(solution.solution(num_list1, n1)); // 1

        int[] num_list2 = {15, 98, 23, 2, 15};
        int n2 = 20;
        System.out.println(solution.solution(num_list2, n2)); // 0
    }
}
